...
TypeScript, Css/Sass modules and CLI for [Modular](https://github.com/kasarda/modular) starter-kit
...
- [Ts-modules](#ts-modules-1)
  - [TypeScript Modules](#typescript-modules)
    ...
    - [Parallax](#parallax)
    - [Worker](#worker)
    - [Hash Router](#hash-router-for-react)
...
- [Hash Router](https://github.com/kasarda/ts-modules/blob/master/router.ts)
- [SASS library](https://github.com/kasarda/ts-modules/blob/master/lib.sass)
- CSS frameworks
  - [animation](https://github.com/kasarda/ts-modules/blob/master/animation.css)
  - [normalize](https://github.com/kasarda/ts-modules/blob/master/normalize.css)
  - [Bootstrap 4 grid](https://github.com/kasarda/ts-modules/blob/master/grid.css)
  - [visibility](https://github.com/kasarda/ts-modules/blob/master/visibility.css)
- CSS autoprefixer
- ...
...
### Hash Router for React
Module to provide simple Hash Routing
```jsx
import * as React from 'react'
import * as ReactDOM from 'react-dom'

import { Router, Routes, Link } from 'ts-modules/react'
...
[animation.css](https://github.com/kasarda/ts-modules/blob/master/animation.css)

```sass
@import '~ts-modules/animation'
```
```html
 <div class="animate ease-in slow zoom-out"></div>
```

### Grid
Bootstrap 4 grid
[grid.css](https://github.com/kasarda/ts-modules/blob/master/grid.css)
...
```
### Visibility
Bootstrap 4 alpha visibility
[visibility.css](https://github.com/kasarda/ts-modules/blob/master/visibility.css)
...
### Normalize
CSS reset
[normalize.css](https://github.com/kasarda/ts-modules/blob/master/normalize.css)
```sass
