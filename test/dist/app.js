...
eval("const Elem = __webpack_require__(/*! ../elem */ \"../elem.js\");\nconst $ = (...s) => new Elem(...s);\nElem.plugin({\n    setColor() {\n        return (color) => {\n            this.target.forEach((target) => {\n                target.style.color = color;\n            });\n        };\n    }\n});\nconst $body = $('body', window);\nconsole.log($body);\n$body.on('click', () => {\n    $body.setColor('red');\n    console.log($body);\n});\n\n\n//# sourceURL=webpack:///./app.ts?");
